...
class SolverBase():
    ...
    def Neff(self):  # TODO: missing keywords
        """Placeholder Neff"""
        raise NotImplementedError(f"Called directly method of SolverBase: define method in child class '{self.solverfile}'")
    ...
    def index1D(self, **kwargs):
        """Placeholder for material index"""
        raise NotImplementedError(f"Called directly method of SolverBase: define method in child class '{self.solverfile}'")
