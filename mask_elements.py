...
from math import sin, cos, acos, atan2, degrees, radians, pi, sqrt, hypot, copysign, tan
...
def Tp_arc2(radius=10, width=1.0, angle=90, xs=None, layer=None, offset=None,
        name=None):
    """Template for creating a parametrized circular arc waveguide function composed of straight sections (minimum angle between sections is 45 deg).
...
def Tp_sinecurve(width=1.0, distance=200, offset=20, xs=None, layer=None,
    ...
    # TODO: add growy
    def cell(
            width=width, distance=distance, offset=offset, xs=xs,
